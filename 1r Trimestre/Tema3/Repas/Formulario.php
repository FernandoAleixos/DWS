...
<body>
    ...
    <form action="Insertar.php" method="post">
        ...
        <p>Tipo<input type="text" name="Tipo" value="<?php if(isset($ropa)){echo $ropa['Tipo'];} ?>" required></p>
        ...
        <p>Id <input type="text" name="Id" value="<?php if(isset($ropa)){echo $ropa['Id'];} ?>" required></p>
